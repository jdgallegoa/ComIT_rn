...
juegosLista.forEach((lista) => {
    // console.log(juegos[lista]);
    console.log(juegos[lista]['nombre']);
    console.log(juegos[lista]['precio']);
    console.log(juegos[lista]['cantidadVendida']);
    console.log(juegos[lista]['localidad']);
    console.log("\t");
});
