...
const juegosLista = Object.keys(juegos);

juegosLista.forEach(lista=>{
    juegos[lista].zona = parseInt(Math.random()*(4-1)+1);
    switch (juegos[lista].zona){
        case 1:
            juegos[lista].localidadFiltrada = 'Capital Federal';
            break;
        case 2:
            juegos[lista].localidadFiltrada = 'Santa Fe';
            break;
        case 3:
            juegos[lista].localidadFiltrada = 'Buenos Aires';
            break;
        default:
            break;
    };
    if(juegos[lista].localidadFiltrada === 'Capital Federal'){
        console.log(lista, juegos[lista])
    }
});
